...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-gray-800 dark:text-white overflow-hidden mt-auto">
      ...
      <div className={`relative container mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-12 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="text-center mb-8 md:mb-10">
          <div className="inline-flex items-center justify-center gap-2 mb-3">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-400 dark:to-emerald-400 bg-clip-text text-transparent">
              HomeGarden
            </h2>
          </div>
          <p className="text-green-600 dark:text-green-400 text-sm sm:text-base font-semibold mb-2">
            Premium Plants & Nursery
          </p>
          <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm max-w-md mx-auto px-4">
            Bringing nature closer to your home with healthy, high-quality plants.
          </p>

          {/* Trust Rating - Premium */}
          <div className="inline-flex items-center gap-2 mt-3 px-3 py-1.5 bg-gray-200/50 dark:bg-white/5 backdrop-blur-sm rounded-full border border-gray-300 dark:border-white/10">
            <div className="flex gap-0.5">
              {[...Array(5)].map((_, i) => (
                <span key={i} className="text-amber-500 dark:text-yellow-400 text-sm">★</span>
              ))}
            </div>
            <span className="text-xs text-gray-700 dark:text-gray-300 font-medium">Trusted by Plant Lovers</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-8">
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-bold text-gray-800 dark:text-white uppercase tracking-wider mb-3 pb-2 border-b-2 border-green-500 inline-block">
              Quick Links
            </h3>
            <div className="grid grid-cols-2 gap-2">
              {quickLinks.map((link, index) => (
                <Link
                  key={index}
                  to={link.path}
                  className="text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 text-sm py-1.5 transition-all duration-300 hover:translate-x-1 inline-flex items-center gap-1 group"
                >
            ...
            <div className="grid grid-cols-2 gap-2">
              {categories.map((cat, index) => (
                <Link
                  ...
                  className={`group relative overflow-hidden bg-gradient-to-r ${cat.color} bg-opacity-10 hover:bg-opacity-20 rounded-lg p-2.5 transition-all duration-300 hover:scale-105 border border-gray-200 dark:border-white/10`}
                >
                  <div className="flex items-center gap-2">
                    <span className="text-lg">{cat.icon}</span>
                    <span className="text-xs font-medium text-gray-800 dark:text-white">{cat.name}</span>
                  </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <a
                ...
                className="flex items-center gap-3 p-2.5 bg-gray-200/50 dark:bg-white/5 backdrop-blur-sm rounded-xl hover:bg-gray-300/50 dark:hover:bg-white/10 transition-all duration-300 group border border-gray-300 dark:border-white/10"
              >
                ...
                <div className="flex-1">
                  <p className="text-[10px] text-gray-500 dark:text-gray-400">Call Us</p>
                  <p className="text-xs font-medium text-gray-800 dark:text-white">+91 8597511728</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-[10px] text-gray-500 dark:text-gray-400">Email Us</p>
                  <p className="text-xs font-medium text-gray-800 dark:text-white truncate">Bikramb2026@gmail.com</p>
                </div>
              </a>

              {/* Address Card - Compact */}
              <div className="flex items-start gap-3 p-2.5 bg-gray-200/50 dark:bg-white/5 backdrop-blur-sm rounded-xl border border-gray-300 dark:border-white/10">
                <div className="w-8 h-8 bg-green-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  <span className="text-green-600 dark:text-green-400 text-base">📍</span>
                </div>
                <div className="flex-1">
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-0.5">Nursery Address</p>
                  <p className="text-[11px] text-gray-700 dark:text-white leading-tight">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mb-6">
          {trustBadges.map((badge, index) => (
            <div
              key={index}
              className={`group relative overflow-hidden bg-gradient-to-r ${badge.accent} bg-opacity-10 hover:bg-opacity-20 rounded-full px-3 py-1.5 transition-all duration-300 hover:scale-105 border border-gray-300 dark:border-white/10`}
            >
              <div className="flex items-center gap-1.5">
                <span className="text-sm">{badge.icon}</span>
                <span className="text-[11px] font-medium text-gray-800 dark:text-white whitespace-nowrap">{badge.text}</span>
              </div>
              <div className="absolute inset-0 bg-white/10 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500"></div>
            </div>
          ))}
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
          {socialLinks.map((social, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`w-9 h-9 bg-gray-200/50 dark:bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg ${social.color} border border-gray-300 dark:border-white/20 text-gray-700 dark:text-white`}
            >
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              {footerLinks.map((link, index) => (
                <Link
                  key={index}
                  to={link.path}
                  className="text-[11px] text-gray-500 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-300"
                >
                  {link.name}
                </Link>
              ))}
